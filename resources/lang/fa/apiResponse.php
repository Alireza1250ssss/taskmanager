...
/*
 * Localized messages for api responses
 */
...
return [
    ...
    'not-validated' => 'اعتبار سنجی با به درستی انجام نشد',
    ...
    'add-viewer' => 'دسترسی مشاهده داده شد',
    'not-company-owner' => "آیتم انتخاب شده مربوط به کمپانی شما نمی باشد",
    'file-missing' => 'فایل موجود نمی باشد مشکلی رخ داده است'
];
